...
def parseJson(ob):
    ...
    return (phone,company,auth,sex,birth_day,jifen,row,name,area,register_time,last_log_in)
...
data = sc.textFile("/commit/credit/huangye88/20170220.huangye88.userinfo.all.20170220") \
    ...
    .saveAsTextFile("/user/lel/temp/huangye88_userinfo")
