CREATE TABLE  if not exists wl_base.t_base_geren_xinxi_data_backflow(
...
load data inpath '/user/lel/temp/ge_ren_xin_xi' into table t_base_geren_xinxi_data_backflow partition(ds='20170504')
