CREATE TABLE  if not exists wl_base.t_base_portrait_data_backflow(
...
load data inpath '/user/lel/temp/portrait' into table t_base_portrait_data_backflow partition(ds='20170504')
