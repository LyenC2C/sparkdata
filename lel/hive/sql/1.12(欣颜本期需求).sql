...
create table if not exists wlservice.t_lel_ec_xinyan_20170112_cd_igk as 
...
awk -F '\001' 'NR==FNR && $3!="Nt1"{a[$2]=$1"\t"$3}NR!=FNR{if(($1 in a))print a[$1]"\t"$2"\t"$3}' t_lel_ec_xinyan_20170112_cd_igk.teltbname xinyan_20170112_cd_igk | sort | uniq >> 20170112

1.distincted_tel

awk -F '\001' 'NR==FNR{a[$1]=$1}NR!=FNR{if(!($1 in a))print $0}' teeth_wrt_tel 20170112 >> 20170112_distincted

3.hadoop fs -put 20170112_distincted_500 /user/lel/results