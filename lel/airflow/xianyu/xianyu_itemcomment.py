...
spark = SSHExecuteOperator(
    task_id="comment_spark",
    bash_command='(bash /home/lel/wolong/sparkdata/lel/airflow/xianyu/source/xianyu_itemcomment_parse.sh)',
    ssh_hook=sshHook,
    dag=dag)

hive = SSHExecuteOperator(
    task_id="comment_hive",
    bash_command='(bash /home/lel/wolong/sparkdata/lel/airflow/xianyu/source/xianyu_itemcomment_import.sh)',
    ssh_hook=sshHook,
    dag=dag)

email = EmailOperator(task_id='xianyu_item_comment_email',
                      to=['lienlian@wolongdata.com'],
                      subject='xianyu item comment workflow',
