...
for i in exec_days:
    ...
    command = "ssh -p 22 wrt@10.3.4.220 bash /home/wrt/sparkdata/lel/airflow/wrt/ec/tb/ec_shopitem_b_backfill.sh {last_day} {last_2_days}".format(last_day=last_day,last_2_days=last_2_days)
    os.system(command)
