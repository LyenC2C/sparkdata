...
#     os.system(command)
command = "bash /home/wrt/sparkdata/lel/airflow/wrt/ec/shopitem_b/backfill/ec_shopitem_b_backfill.sh {last_day} {last_2_days}".format(last_day='20170204',last_2_days='20170124')
os.system(command)