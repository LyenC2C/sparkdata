...
as feature
from
wlcredit.t_credit_record_cate1_feature_months_online t1
left JOIN
wlcredit.t_credit_record_cate2_feature_months_online t2
ON
t1.tel_index = t2.tel_index
left JOIN
wlcredit.t_credit_record_cate3_feature_months_online t3
ON
t1.tel_index = t3.tel_index
left JOIN
wlcredit.t_credit_record_cate4_feature_months_online t4
ON
t1.tel_index = t4.tel_index
;
