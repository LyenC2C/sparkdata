...
where c.price is not null and a.rn<4 and a.price<59999 and a.dsn >'20151031'
...
where rn<4 and price<59999   and  dsn >'20151031'
group by tel;
...
from wlservice.t_zlj_tmp_rong360_1w_record  where rn<4 and price<59999   and  dsn >'20151031'
group by tel
;
