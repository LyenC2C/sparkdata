...
hadoop fs -rm -r /user/wrt/daysale_tmp
spark-submit  --total-executor-cores  80   --executor-memory  6g  --driver-memory 20g \
$pre_path/wrt/data_base_process/cal_daysale.py $qiantian $zuotian >> ./log_daysale/log_$qiantian 2>&1
sh $pre_path/wrt/data_base_process/cal_daysale.sql $qiantian >> ./log_daysale/log_$qiantian 2>&1
...
hadoop fs -rm -r /user/wrt/daysale_tmp
spark-submit  --total-executor-cores  80   --executor-memory  6g  --driver-memory 10g \
$pre_path/wrt/data_base_process/cal_daysale.py $qiantian $zuotian >> ./log_daysale/log_$qiantian 2>&1
sh $pre_path/wrt/data_base_process/cal_daysale.sql $qiantian >> ./log_daysale/log_$qiantian 2>&1
...
#spark-submit  --executor-memory 20G  --driver-memory 20g  --total-executor-cores 200 \
...
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151027
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151028
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151029
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151030
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151102
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151104
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151105
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151106
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151107
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151108
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151109
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151110
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151111
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151112
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151113
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151114
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151115
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151116
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151117
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151118
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151119
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151120
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151121
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151122
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151123
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151124
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151125
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151126
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151127
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151128
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151129
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151130
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151201
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151202
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151203
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151204
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151205
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151206
#spark-submit  --total-executor-cores  120  --executor-memory 20g  --driver-memory 16g $pre_path/wrt/data_base_process/ 20151207
