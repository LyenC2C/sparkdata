...
#$pre_path/wrt/data_base_process/t_wrt_base_ec_item_sale.py $qiantian $zuotian 20160106 >> ./log_date/log_$zuotian 2>&1
#sh $pre_path/wrt/data_base_process/t_wrt_base_ec_item_sale.sql $zuotian >> ./log_date/log_$zuotian 2>&1
#
#sh $pre_path/zlj/project/task/zhejiang/everyday_sold.sql $qiantian $zuotian 20160106 20160106 >> ./log_date/log_$zuotian 2>&1
