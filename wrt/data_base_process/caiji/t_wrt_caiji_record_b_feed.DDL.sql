...
insert overwrite table wl_analysis.t_wrt_caiji_record_b_feed partition (ds = '20170104')
...
t1.sold
from
(select item_id,sold from wlbase_dev.t_base_ec_shopitem_b where ds = 20170103)t1
left join
