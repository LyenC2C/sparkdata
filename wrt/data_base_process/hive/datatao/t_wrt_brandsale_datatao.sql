create table t_wrt_brandsale_datatao(
brand_id String,
total_sold String,
day_sold STRING,
...
(
select /*+ mapjoin(t_wrt_branditem_datatao)*/
t_wrt_branditem_datatao.brand_id,tt.item_id,tt.total_sold,tt.ds FROM
t_wrt_branditem_datatao
JOIN
(
select item_id,total_sold,ds from
t_base_ec_item_sale_dev where ds >= 20160301 and ds<= 20160310
)tt
ON
tt.item_id = t_wrt_branditem_datatao.item_id
)t1
join
(
