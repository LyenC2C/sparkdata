...
t_base_ec_item_dev where ds = 20160225 and root_cat_id = 25 and bc_type = 'B' and brand_id <> '-'
...
select count(1) FROM
(select brand_id,max(brand_name) as brand_name from
t_base_ec_item_dev where ds = 20160225 and
root_cat_id = 25
 and bc_type = 'B' and brand_id <> '-' group by brand_id)t;