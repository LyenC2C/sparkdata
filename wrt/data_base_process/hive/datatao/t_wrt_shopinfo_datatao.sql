...
join
(select shop_id from t_base_ec_item_dev where ds = 20160225 and (root_cat_id = 50010788 and cat_id <> 50010815) group by shop_id limit 100)t2
on
...
--查看数量
select count(1) from(
select shop_id from t_base_ec_item_dev where ds = 20160225 and (root_cat_id = 50010788 and cat_id <> 50010815) and bc_type = 'B' group by shop_id
)t;