...
scp $save_path/znk_development_$now_day hadoop@10.1.4.251:/media/disk1/shuyang/$now_day/

scp $save_path/znk_othercat_$now_day hadoop@10.1.4.251:/media/disk1/shuyang/$now_day/
