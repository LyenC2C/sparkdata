...
hiveContext.sql('Insert overwrite table t_base_q_user_dev_wrt  PARTITION(ds=20151112)'
                ...
                'case when qqage.age < 150 and qqage.age >5 then qqage.age else cast(qqage.age as int) end age'
                'from qqinfo left join qqage'
                'on qqage.qq=qqinfo.uin')
sc.stop()
