CREATE TABLE  if not exists wl_base.t_base_user_profile(
tb_id String COMMENT '淘宝id',
alipay String COMMENT '支付宝实名验证',
buycnt String COMMENT '用户从注册到16年5月购买商品总数',
verify String COMMENT '用户淘宝等级 0-6',
regtime String COMMENT '用户淘宝注册时间',
tb_nick String COMMENT '淘宝昵称',
tb_location String COMMENT '淘宝地址',
qq_gender String COMMENT 'qq性别',
qq_age int COMMENT 'qq年龄',
qq_name String COMMENT 'qq姓名',
qq_loc String COMMENT 'qq地址',
tel_prov String COMMENT '手机号对应地址省份',
tel_city String COMMENT '手机号对应地址城市',
xianyu_gender String COMMENT '闲鱼性别',
xianyu_birthday int COMMENT '闲鱼年龄（出生年月转换而来）',
xianyu_constellation String COMMENT '用户从注册到16年5月购买商品总数',
xianyu_province String COMMENT '闲鱼省份',
xianyu_city String COMMENT '闲鱼城市',
predict_gender int COMMENT '模型预测年龄覆盖所有够买用户',
xianyu_detail_loc  String COMMENT '闲鱼详细地址（通过GPS坐标转换）',
weibo_id bigint COMMENT '微博 ID',
weibo_screen_name String COMMENT '微博姓名',
weibo_gender String COMMENT '微博性别',
weibo_followers_count int COMMENT '微博关注数',
weibo_friends_count int COMMENT '微博被关注数',
weibo_statuses_count int COMMENT '微博总条数',
weibo_created_at String COMMENT '微博注册时间',
weibo_verified String COMMENT '是否大v认证',
weibo_location String COMMENT 'weibo地址',
weibo_colleges String COMMENT '微博教育信息',
weibo_company String COMMENT '微博职位信息',
58_tel String COMMENT '58_tel',
58_nickname String COMMENT '58名字'
)
COMMENT 'profile'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\001'  LINES TERMINATED BY '\n' stored as textfile;

CREATE TABLE  if not exists wl_base.t_base_user_profile_telindex(
tel_index string,
tb_id string,
alipay string,
buycnt string,
...
qq_name string,
qq_loc string,
qq_find_schools string,
tel_loc string,
xianyu_gender string,
xianyu_birthday int,
xianyu_constellation string,
xianyu_province string,
xianyu_city string,
xianyu_detail_loc string ,
model_predict_gender int,
weibo_id string,
weibo_screen_name string,
weibo_gender string,
weibo_followers_count int,
weibo_friends_count int,
weibo_statuses_count int,
weibo_created_at string,
weibo_location string,
weibo_verified string,
weibo_colleges string,
weibo_company string,
58_tel string,
58_nickname string
)
COMMENT 'profile_telindex'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\001'  LINES TERMINATED BY '\n' stored as textfile;
1男 2女
