...
for step  in [2]:
    ...
    lr_rs.to_csv(u'E:\\项目\\征信&金融\\模型\\rong360\\fix\\step2_ks.csv')
...
# result_preb.to_csv(u'E:\\项目\\征信&金融\\模型\\rong360\\fix\\record_label_v_cat_valid_result.csv')
...
#
# print mean_rs['rs']
# print len(mean_rs['label']), len(mean_rs['rs'])
# mean_auc=metrics.roc_auc_score(test_Y, means)
