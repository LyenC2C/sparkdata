...
drop table wlcredit.t_credit_record_cate1_12month_feature ;
create table wlcredit.t_credit_record_cate1_12month_feature as
SELECT
...
from wlbase_dev.t_base_record_cate_simple where
and regexp_replace(date_sub(from_unixtime( unix_timestamp() ,'yyyy-MM-dd'),30*12),'-','' )>dsn
