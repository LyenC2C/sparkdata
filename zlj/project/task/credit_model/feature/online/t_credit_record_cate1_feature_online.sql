-- 价格的加减乘除
drop table wl_credit.t_credit_record_cate1_feature_online ;
create table wl_credit.t_credit_record_cate1_feature_online as
SELECT
...
concat_ws(':', concat_ws('_'h,cast( root_cat_id as string) ,'price_075_level1') ,cast( round(percentile(cast(price as int),0.75),2) as string) ) price_075
from
