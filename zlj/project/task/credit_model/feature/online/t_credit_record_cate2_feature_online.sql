...
drop table wlcredit.t_credit_record_cate2_feature_online ;
create table wlcredit.t_credit_record_cate2_feature_online as
SELECT
tel_index ,
...
concat_ws(':', concat_ws('_',cast( cate_level2_id as string) ,'price_025_level2') ,cast( round(percentile(cast(price as int),0.25),2) as string) ) price_025,
concat_ws(':', concat_ws('_',cast( cate_level2_id as string) ,'price_010_level2') ,cast( round(percentile(cast(price as int),0.10),2) as string) ) price_010,
