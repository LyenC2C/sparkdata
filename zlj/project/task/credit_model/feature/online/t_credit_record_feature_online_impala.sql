drop table wl_feature.t_credit_record_feature_online_impala ;
create table wl_feature.t_credit_record_feature_online_impala as
SELECT
tel_index,
...
round(stddev(price),2)   monthall_price_std,
