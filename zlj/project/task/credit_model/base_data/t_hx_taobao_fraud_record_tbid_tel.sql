...
drop table wlfinance.t_hx_taobao_fraud_record_tmp;
create table wlfinance.t_hx_taobao_fraud_record_tmp as
select
 user_id,
 dsn,
...
drop table wlfinance.t_hx_taobao_fraud_record_tbid_tel; 
create table wlfinance.t_hx_taobao_fraud_record_tbid_tel as 
SELECT
t2.tel ,
 user_id,
 dsn,
 feed_id,title,keywords
from  wlfinance.t_hx_taobao_fraud_record_tmp t1 
join 
wlrefer.t_zlj_uid_name t2 on t1.user_id =t2.tb  where tel is not null ;
