...
-- 补全id
DROP  table t_zlj_dc_weibodata_final_3w_buquan_1019;
create table t_zlj_dc_weibodata_final_3w_buquan_1019 as
SELECT
   mid,
...
(
  SELECT *,NULL as next_user_name_id
    from t_zlj_dc_weibodata where length(next_user_name)<2 and ds=20161019
    UNION ALL
  SELECT
    t1.*,
