...
#create table stats(id int not null auto_increment primary key,d_name varchar(50) default 'wl_base',t_name varchar(50) not null,total_size varchar(200),total_files varchar(200),avg_size varchar(200),rows bigint default 0,date varchar(20));
HOSTNAME="10.3.4.104"
PORT="3306"
USERNAME="airflow"
PASSWORD="airflow"
