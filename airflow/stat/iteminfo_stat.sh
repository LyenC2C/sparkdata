...
lastday_rows=`hive -S -e "SELECT count(*) FROM $database.$table where ds='$lastday'"`
...
last_2_days_rows=`hive -S -e "SELECT count(*) FROM $database.$table where ds='$last_2_days'"`
