...
#create table stats(id int not null auto_increment primary key,d_name varchar(50) default 'wl_base',t_name varchar(50) not null,total_size varchar(200),total_files varchar(200),avg_size varchar(200),rows varchar(200),date varchar(20),ts TIMESTAMP(6) not NULL DEFAULT CURRENT_TIMESTAMP(6));HOSTNAME="10.3.4.104"
PORT="3306"
USERNAME="airflow"
PASSWORD="airflow"
DBNAME="airflow"
...
insert_sql="insert IGNORE into ${TABLENAME} values(null,'$1','$2','$lastday_size','$lastday_files','$lastday_avg_size','$lastday_rows','$lastday')"
