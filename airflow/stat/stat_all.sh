...
bash $path/static_stat_impala.sh wl_base t_wrt_shixin_qiye >> ~/stat/stat2.log
bash $path/static_stat_impala.sh wl_base t_wrt_shixin_person >> ~/stat/stat2.log
bash $path/static_stat_impala.sh wl_base t_base_credit_ppd_listinfo >> ~/stat/stat2.log
