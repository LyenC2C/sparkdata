...
hadoop fs -test -e /hive/warehouse/wl_base.db/t_base_record_data_backflow/ds=$today
if [ $? -eq 0 ] ;then
    hadoop fs -rmr /hive/warehouse/wl_base.db/t_base_record_data_backflow/ds=$today
else
    echo 'Directory is not exist,go ahead!!!'
fi
